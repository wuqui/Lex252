...
| Phonology | stress pattern? | *record* N vs V |
| Semantic | unitary meaning? | *finally* ≠ *in the end* |
| Orthography | spacing/hyphens? | *alright* vs *all right* |
| Dictionary | listed? | *un-* (sub-lexical but listed) |

---

## Micro-check: Is this a word?
...
- evidence to check:
    ...
    - variant forms list
    - example citations
- OED finding: *honey bee* (primary); *honeybee* (variant)
...
Examples: THEORY → *theorist*, *theoretical*, *theorise*

---

### Micro-check: Paradigms

Supply one derived form for the base: employ → …

::: {.fragment}
→ *employer* / *employable* (derivational)
:::

Identify the inflected form: *walk* → …

::: {.fragment}
→ *walks* / *walked* / *walking* (inflectional)
:::
...
- pairs (A/B)
- A drives lookups; B takes notes; switch roles per task
...
- **Task B** (compare entries): entry structure? cross-references? example density?
- **Task C** (extract citations + hypothesise): fixedness cues? semantic transparency? paradigmatic alternatives?
