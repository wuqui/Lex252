...
- 2–3 minutes; contrast external relations vs internal item structure.
- Ask: Give a paradigmatic alternative to *vehicle*. Then: a collocation for *tea*.
- Build example live: *unhappiness* from morphemes; contrast with polysemy of *bank*.
- Bridge: Later sessions cover morphology and collocation/semantics in depth.
:::
___
...
::: {.notes}
- 1–2 minutes, mostly examples; elicit one per line from students.
- Prompt: “Another collocate for tea?” “One derivation from create?”
:::
